...
public class ItripHotelOrder  implements Serializable {
    ...
    public ItripHotelOrder(Long id, Long userid, Integer ordertype, String orderno, String tradeno, Long hotelid, String hotelname, Long roomid, Integer count, Integer bookingdays, Date checkindate, Date checkoutdate, Integer orderstatus, BigDecimal payamount, Integer paytype, String noticephone, String noticeemail, Integer isneedinvoice, Integer invoicetype, String invoicehead, String linkusername, Integer booktype, Date creationdate, Long createdby, Date modifydate, Long modifiedby, String specialrequirement) {
        this.id = id;
        this.userid = userid;
